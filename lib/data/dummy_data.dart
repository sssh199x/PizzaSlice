...
import 'package:pizzaslice/models/donut.dart';
import 'package:pizzaslice/models/nutrient.dart';
import 'package:pizzaslice/models/smoothie.dart';
import 'package:pizzaslice/utils/assets.dart';
...
List<TabBarItem> tabBarItems = [
  TabBarItem(
      name: "Donuts", image: AppAssets.homePageAssets.homepageTabIconDonut),
  TabBarItem(
      name: "Burgers", image: AppAssets.homePageAssets.homepageTabIconBurger),
  TabBarItem(
      name: "Smoothies",
      image: AppAssets.homePageAssets.homepageTabIconSmoothie),
  TabBarItem(
      name: "Pancakes", image: AppAssets.homePageAssets.homepageTabIconPancake),
  TabBarItem(
      name: "Pizzas", image: AppAssets.homePageAssets.homepageTabIconPizza),
];
...
List<String> allPizzaImages =
    List.generate(9, (index) => 'assets/images/pizzas/${index + 1}.png');
...
List<RemixPizza> allRemixAblePizzas = List.generate(
    ...
    (index) => RemixPizza(
        ...
        halfPrice: notSoRandomHalfPrice(),
